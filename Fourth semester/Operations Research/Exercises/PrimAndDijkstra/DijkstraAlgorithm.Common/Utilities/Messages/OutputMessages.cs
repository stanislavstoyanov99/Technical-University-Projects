namespace DijkstraAlgorithm.Common.Utilities.Messages
{
    public static class OutputMessages
    {
        public const string Initialization
            = "Algorithm has started execution.";

        public const string FinishedExecution
            = "Algorithm has finished execution.";
